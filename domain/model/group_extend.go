...
type GroupExtend struct {
	...
	GroupVersion interface{} `gorm:"column:group_version;type:int(11);comment:'group 版本'" json:"group_version"`
	DataVersion  interface{} `gorm:"column:data_version;type:int(11);comment:'data 版本'" json:"data_version"`
}
